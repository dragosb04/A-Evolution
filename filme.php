...
?>
<main id="site-main" class="page page-template filme text-light">
            ...
            <div class="row">
                ...
                <?php
                    if ($car == 'F') {
                        ...
                        if ($check !== 'Anime' && $check !== 'Filme' && $check !== 'Manga' && $check !== 'Serii Anime Terminate' && $check !== 'Serii Anime în curs de traducere') {
                            echo '
