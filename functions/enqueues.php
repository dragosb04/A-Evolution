...
if (!function_exists('b4st_enqueues')) {
	function b4st_enqueues()
	{
		...
		wp_register_style('theme', get_template_directory_uri() . '/theme/css/evo-style.css', false, null);
		...
		wp_register_script('theme', get_template_directory_uri() . '/theme/js/b4st.js?1200', false, null, true);
